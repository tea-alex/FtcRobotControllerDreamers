...
public class OpenCV_Contour_3954_Test extends LinearOpMode {
    ...
    static final double     DRIVE_SPEED_LIFT        = 0.4;     // Max driving speed for better distance accuracy.
...
//    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 170.0, 120.0);
    ...
    public void driveStraight(double maxDriveSpeed, double distance, double heading) {
        ...
        if (opModeIsActive()) {
            ...
            leftTarget = robot.leftFrontDrive.getCurrentPosition() + moveCounts;
            rightTarget = robot.rightFrontDrive.getCurrentPosition() + moveCounts;
    ...
    public void moveRobot(double drive, double turn) {
        ...
        robot.leftFrontDrive.setPower(leftSpeed * MULTIPLIER);
        robot.rightFrontDrive.setPower(rightSpeed * MULTIPLIER);
    }
    ...
    private void sendTelemetry(boolean straight) {
        ...
        if (straight) {
            ...
            telemetry.addData("Actual Pos L:R",  "%7d:%7d",      robot.leftFrontDrive.getCurrentPosition(), robot.rightFrontDrive.getCurrentPosition());
        } else {
    ...
    public void turnMecanum(double drive,double turn) {
        ...
        robot.leftFrontDrive.setPower(leftSpeed * MULTIPLIER);
        robot.rightFrontDrive.setPower(rightSpeed * MULTIPLIER);
        robot.leftBackDrive.setPower(leftSpeed * MULTIPLIER);
        robot.rightBackDrive.setPower(rightSpeed * MULTIPLIER);
    }
